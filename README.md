...
# 第2章 开发环境与技术
社区疫情联防联控系统的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对社区疫情联防联控系统用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
社区疫情联防联控系统经过分析，确定了其需要设置管理员的角色，其操作的功能通过用例图展示（见下图）。管理员管理工作人员，住户，管理核酸检测，管理隔离监控，管理疫情上报，管理住户的出入信息以及访客的来访信息等。
